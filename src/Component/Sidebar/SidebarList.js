...
import { FcHome, FcNightPortrait, FcTodoList, FcContacts, FcFactory, FcSalesPerformance, FcAbout } from "react-icons/fc";
        ...
        <div className='navbar-items'>
                ...
                <ul>
                    ...
                    <Link to='tech-stack' 
                        ...
                        duration={100}
                        offset={-100}>
                        <MdBiotech size={25} color="yellow"/> Tech Stack 
                    </Link>    
                    </li>
                    <li className='nav-item'>
                    <Link to='education' 
                ...
                <div className='navbar-items-only-icons'>
                    ...
                    <Link to='tech-stack' 
                        ...
                        duration={100}
                        offset={-100}>
                        <MdBiotech size={25} color="yellow"/> 
                    </Link>    
                    </li>
                    <li className='nav-item'>
                    <Link to='education' 
